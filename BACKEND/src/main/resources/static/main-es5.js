...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClinicalCenterAdministratorService = /** @class */ (function () {
                ...
                ClinicalCenterAdministratorService.prototype.addCodebook = function (codebook) {
                    return this.http.post(this.urlCCAdmin + "/addCodebook", codebook).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return data; }));
                };
                ClinicalCenterAdministratorService.prototype.deleteCodebook = function (codebook) {
                    // alert(JSON.stringify(codebook));
                    return this.http.post(this.urlCCAdmin + "/deleteCodebook", codebook).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return data; }));
                };
