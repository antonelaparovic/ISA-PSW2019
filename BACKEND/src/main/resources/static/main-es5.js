...
>>>>>>> Stashed changes
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_ccadmin_profile_ccadmin_profile_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ./components/ccadmin-profile/ccadmin-profile.component */
    "./src/app/components/ccadmin-profile/ccadmin-profile.component.ts");
    /* harmony import */


    var _components_allpatients_page_allpatients_page_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! ./components/allpatients-page/allpatients-page.component */
    "./src/app/components/allpatients-page/allpatients-page.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      entryComponents: [_components_ccadmin_profile_ccadmin_profile_component__WEBPACK_IMPORTED_MODULE_23__["CCAdminProfileComponent"], _components_allpatients_page_allpatients_page_component__WEBPACK_IMPORTED_MODULE_24__["AllPatientsPageComponent"]],
      providers: [],
  ...
  function srcAppComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_clinicalCenterAdministrator_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          ...
          if (this.user.role === _models_role__WEBPACK_IMPORTED_MODULE_5__["Role"].PATIENT && this.loginUser.password === this.user.password) {
            ...
            this.ccadminService.loginCCAdmin(this.user).subscribe(function (data) {
              ...
              if (data !== null) {
                ...
                _this3.router.navigate(['/clinicalCenterAdministrator/profile']);
              } else {
    ...
    function () {
      ...
      _createClass(ClinicalCenterAdministratorService, [{
        ...
        value: function getCCAdmin(email) {
          ...
          try {
            for (var _iterator3 = this.listCCAdmin[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              var u = _step3.value;
        ...
        value: function setCCAdmin(p) {
          ...
          try {
            for (var _iterator4 = this.listCCAdmin[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              var p1 = _step4.value;
          ...
          this.http.get(this.urlCCAdmin + '/all').subscribe(function (data) {
            ...
            try {
              for (var _iterator5 = data[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                var c = _step5.value;
                _this7.clinicalCenterAdministrator = new _models_clinicalCenterAdministrator__WEBPACK_IMPORTED_MODULE_2__["ClinicalCenterAdministrator"](c.email, c.password, c.name, c.surname, c.number);

                _this7.addCCAdmin(_this7.clinicalCenterAdministrator);
              }
            } catch (err) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CodebookComponent = /** @class */ (function () {
                ...
                CodebookComponent.prototype.addCodebookMedicine = function () {
                    ...
                    this.codebookService.addCodebook(si).subscribe(function (data) { _this.codebookService = data; });
                };
                CodebookComponent.prototype.deleteMedicine = function (medicine) {
                    ...
                    this.codebookService.deleteCodebook(si).subscribe(function (data) { _this.codebookService = data; });
                };
                ...
                CodebookComponent.prototype.deleteDiagnose = function (diagnose) {
                    ...
                    this.codebookService.deleteCodebook(codebook).subscribe(function (data) { _this.codebookService = data; });
                };
