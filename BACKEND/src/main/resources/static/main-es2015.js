...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h1>Welcome clinicadministrator!</h1>\r\n");
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var src_app_models_clinicAdministrator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/models/clinicAdministrator */ "./src/app/models/clinicAdministrator.ts");
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_services_clinic_administrator_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/clinic-administrator.service */ "./src/app/services/clinic-administrator.service.ts");
/* harmony import */ var src_app_models_role__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/models/role */ "./src/app/models/role.ts");
...
let ClinicadministratorProfileComponent = class ClinicadministratorProfileComponent {
    constructor(formBuilder, router, clinicAdministratorService, userService) {
        this.formBuilder = formBuilder;
        this.router = router;
    ...
    ngOnInit() {
        this.clinicAdministratorProfileForm = this.formBuilder.group({
            ...
            password: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.selectedClinicAdministrator.password, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(8),
...
/* harmony import */ var src_app_services_clinicalCenterAdministrator_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/services/clinicalCenterAdministrator.service */ "./src/app/services/clinicalCenterAdministrator.service.ts");
/* harmony import */ var src_app_services_clinic_administrator_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/services/clinic-administrator.service */ "./src/app/services/clinic-administrator.service.ts");
...
let LoginComponent = class LoginComponent {
    constructor(patientService, formBuilder, router, userService, doctorService, nurseService, clinicAdministratorService, recordService, ccadminService) {
        this.patientService = patientService;
        this.formBuilder = formBuilder;
        this.router = router;
        this.userService = userService;
    ...
    attemptLogin() {
        if (this.user.role === _models_role__WEBPACK_IMPORTED_MODULE_5__["Role"].PATIENT && this.loginUser.password === this.user.password) {
            ...
            console.log(this.user);
            this.clinicAdministratorService.loginClinicAdministrator(this.user).subscribe(data => {
                console.log(data);
                if (data !== null) {
                    console.log('Successful logged in');
                    this.router.navigate(['/clinicAdministrator/home']);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _models_zahtev__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../models/zahtev */ "./src/app/models/zahtev.ts");
...
/* harmony import */ var _models_zahtevStatus__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../models/zahtevStatus */ "./src/app/models/zahtevStatus.ts");
...
NurseVacationRequestComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./nurse-vacation-req.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/nurse-vacation-req/nurse-vacation-req.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./nurse-vacation-req.component.css */ "./src/app/components/nurse-vacation-req/nurse-vacation-req.component.css")).default]
    })
...
/* harmony import */ var _models_zahtevStatus__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../models/zahtevStatus */ "./src/app/models/zahtevStatus.ts");
...
class ClinicAdministrator {
    constructor(email, password, name, surname, number1, clinic) {
        this.email = email;
        this.password = password;
        this.name = name;
...
class Nurse {
    constructor(email, password, name, surname, number1, address, city, country, workHoursTo, workHoursFrom) {
        this.email = email;
        this.name = name;
        this.password = password;
        this.surname = surname;
...
/* harmony import */ var _models_clinicAdministrator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/clinicAdministrator */ "./src/app/models/clinicAdministrator.ts");
...
let ClinicAdministratorService = class ClinicAdministratorService {
    ...
    loginClinicAdministrator(clinicAdministrator) {
        ...
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].baseUrl + '/login', clinicAdministrator, { responseType: 'text' });
    }
    ...
    getAllClinicAdministrators() {
        this.http.get(this.urlClinicAdministrator + '/all').subscribe((data) => {
            for (const c of data) {
                this.clinicAdministrator = new _models_clinicAdministrator__WEBPACK_IMPORTED_MODULE_3__["ClinicAdministrator"](c.email, c.password, c.name, c.surname, c.number, c.clinic);
                console.log(c);
...
let NurseService = class NurseService {
    ...
    getAllNurses() {
        this.http.get(this.urlNurse + '/all').subscribe((data) => {
            for (const c of data) {
                this.nurse = new _models_nurse__WEBPACK_IMPORTED_MODULE_2__["Nurse"](c.email, c.password, c.name, c.surname, c.number, c.address, c.city, c.country, c.workHoursFrom, c.workHoursTo);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _models_zahtev__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/zahtev */ "./src/app/models/zahtev.ts");
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../environments/environment */ "./src/environments/environment.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./user.service */ "./src/app/services/user.service.ts");
/* harmony import */ var _models_zahtevStatus__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/zahtevStatus */ "./src/app/models/zahtevStatus.ts");
...
let VacationService = class VacationService {
    ...
    getAllVacations() {
        this.http.get(this.urlVacation + '/all').subscribe((data) => {
            for (const c of data) {
                this.zahtev = new _models_zahtev__WEBPACK_IMPORTED_MODULE_2__["Zahtev"](c.email, c.name, c.surname, c.startingDate, c.finishDate, this.whichStatus(c.status.toString()));
    ...
    getAllRequests() {
        this.http.get(this.urlVacation + '/VacationRequest').subscribe((data) => {
            this.tmp = new Array();
            for (const c of data) {
                this.zahtev = new _models_zahtev__WEBPACK_IMPORTED_MODULE_2__["Zahtev"](c.email, c.name, c.surname, c.startingDate, c.finishDate, _models_zahtevStatus__WEBPACK_IMPORTED_MODULE_6__["ZahtevStatus"].AWAITING_APPROVAL);
